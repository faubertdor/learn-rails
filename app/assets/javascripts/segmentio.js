...
window.analytics.load = function (apiKey) {
    ...
    'd2dq2ahtl5zl1z.cloudfront.net/analytics.js/v1/' + apiKey + '/analytics.min.js'// Find the first script element on the page and insert our script next to it.
...
window.analytics.load('I9LCr2aLrdT33vOy2Yp0RCdMwHhWK2ac');
